package dev.gaphunter.elasticsearchclientreusecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.elasticsearchclientreusecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.elasticsearchclientreusecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Elasticsearch Client Reuse Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33878-elasticsearch-client-reuse-companion/reviews"
